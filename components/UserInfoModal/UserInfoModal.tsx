      ...
      <Dialog as="div" className="relative z-50" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center p-6 justify-center text-center">
            ...
            >
              <Dialog.Panel className="w-full transform overflow-hidden rounded-xl bg-white text-left align-middle shadow-xl transition-all max-w-[460px]">
                ...
                <div className="p-5 pt-0">
                  <div className="relative">
                    <button className="absolute top-2 right-2" onClick={onCopy}>
                      {hasCopied ? (
                        <IconCheckFilled className="text-emerald-400" />
                      ) : (
                        <IconCopy />
                      )}
                    </button>
